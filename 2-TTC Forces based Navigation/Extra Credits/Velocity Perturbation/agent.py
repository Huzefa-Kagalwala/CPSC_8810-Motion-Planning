...
# This Velocity Perturbation Method is implemented in the TTC Model
...
class Agent(object):
    ...
    def __init__(self, csvParameters, ksi = 0.5, dhor = 10, timehor = 5, goalRadiusSq = 1, maxF = 10):
        ...
        self.eta = random.choice(cand_vel) # Choosing a random velocity to add as perturbation
                ...
                if obj_sense_dist < 10:
                    ...
                    if ttc_val != np.inf:
                        if ttc_val < ttc_fin:
                            ...
                            rel_vel = self.vel - i.vel + self.eta
