...
Note: It takes typically 30 seconds for the roadmap to get constructed. Nonetheless, please allow upto 60 seconds for some rare cases. Otherwise, terminate the program and rerun.

QUERY PHASE:
Here, the A* search algorithm is used to compute the path . This was done through "find_path" function which takes in start node, goal node and the graph as arguments. 
ADDING THE QUERY NODES:
